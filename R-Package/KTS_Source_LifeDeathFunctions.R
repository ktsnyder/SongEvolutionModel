...
# Edited by Kate Snyder 6/6/2022 - BirthDeathCycle
...
#' @export
BirthDeathCycle <- function(P, population, Stress = FALSE, StressAccuracyHit = NULL){
  ...
  Chicks <- GenerateChicks(P, FatherInd, population, Vacancy, Stress, StressAccuracyHit)  # KTS added stress
  ...
  if(P$FEvo){population <- FemaleEvolve(P, population, Vacancy, FatherInd)}  # should stress affect Females? Add in this fxn if so
